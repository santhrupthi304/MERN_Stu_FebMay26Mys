...
// Middleware can inspect or change the request before a route response
// next() passes conrtol to the next step
...
app.listen(4000,function(){
    console.log("Express server running at http://localhost:4000");//system will be both server & client
});
